*[Course Assignments & Due Dates](https://github.com/cs-4241-2023/cs-4241-2023.github.io/blob/main/cal.md)*
...
Note that Monday September 4th is a holiday (Labor Day); no class will be held.
...
creative coding in the browser, web decentralization, and the environmental impact of web design and development.
...
Students will be expected to use Git in this class and all assignments will be turned in using GitHub. Please begin familiarizing yourselves with 
Git if you don't have prior experience with it; it will not be taught in the class. The course TAs/SAs can provide help with Git for those who need it; please take advantage of their expertise!
...
Late homework is not accepted without a medical reason or prior permission from the course instructor. Please DM both the course instructor and the primary grader (Akim) for small extensions. If it is a personal matter you which to discuss it's of course fine to only contact the instructor. *It is much better to submit partially complete work than nothing at all.* 
