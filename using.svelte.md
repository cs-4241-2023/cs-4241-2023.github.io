...
We'll use the vite-express server to deliver our static files as compiled by Svelte. You can follow the [instructions
for setting up Vite + Express](https://github.com/szymmis/vite-express) to create your project and get it running.
